...
twoway ///
	scatter EC_measure1_percent country_v2, ///
		mcolor("104 34 139") xtitle("Country", color("0 0 139")) xscale(lwidth(medthick) lcolor("0 0 139")) || ///
	rcap lb_EC_measure1_percent ub_EC_measure1_percent country_v2, ///
		ylabel(0(1)4, labcolor("0 0 139") tlcolor("0 0 139") glcolor("104 34 139" %15)) ///
		ytick(0(.5)4) ytitle("Percent", color("0 0 139")) yscale(lwidth(medthick) lcolor("0 0 139")) ///
		xlabel(1 "Burkina Faso" 2 "Cote d'Ivoire" 3 "DRC Kinshasa" 4 "DRC Kongo Central" 5 "Ethiopia" ///
			6 "Ghana" 7 "India Rajasthan" 8 "Kenya" 9 "Niger" 10 "Nigeria Anambra" 11 "Nigeria Kaduna" ///
			12 "Nigeria Kano" 13 "Nigeria Lagos" 14 "Nigeria Nasarawa" 15 "Nigeria Rivers" 16 "Nigeria Taraba" ///
			17 "Uganda", angle(45) labsize(small) labcolor("0 0 139") tlcolor("0 0 139")) ///
		lcolor("104 34 139") ///
...
graph save "/Users/ealarson/Dropbox (Gates Institute)/1 DataManagement_General/X 9 EC use/Report Draft/New Graphs/Graph_1_presentation", replace
